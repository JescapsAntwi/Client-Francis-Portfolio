...
const DownloadCV = () => {
  // This function would typically download the CV file
  // For now it's just a placeholder function
  const handleDownload = () => {
    alert("CV download functionality would be implemented here. Currently this is a placeholder.");
    // In a real implementation, this would trigger the download:
    // window.open('/path-to-cv-file.pdf', '_blank');
  };
      ...
      <div className="section-container">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="md:w-2/3 space-y-4">
            <h2 className="text-3xl font-bold">Want to know more about my experience?</h2>
            <p className="text-white/80 max-w-2xl">
              Download my curriculum vitae to get detailed information about my education, 
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 hover:bg-white/15 transition-colors">
            ...
            <p className="text-white/80 mb-4">
              Get a comprehensive overview of my professional journey and educational background.
            </p>
            <Button 
              variant="link" 
              onClick={handleDownload}
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 hover:bg-white/15 transition-colors">
            ...
            <p className="text-white/80 mb-4">
              Explore my work history, including forex trading experience and event organization projects.
            </p>
            <Button 
              variant="link" 
              onClick={handleDownload}
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 hover:bg-white/15 transition-colors">
            ...
            <p className="text-white/80 mb-4">
              Review a detailed breakdown of my business, trading, and interpersonal skills.
            </p>
            <Button 
              variant="link" 
              onClick={handleDownload}
